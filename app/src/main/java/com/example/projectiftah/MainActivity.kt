package com.example.projectiftah
    ...
    override fun onClick(v: View?) {
        when (v?.id) {
            ...
            R.id.btn_pindah_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "M Iftah Al Ulya Maolana")
            ...
            R.id.btn_move_activity_object -> {
                val data = Data(
                    "M Iftah Al Ulya Maolana",
                    20,
                    "iftahmaolana17@gmail.com",
                    "Pekanbaru"
                )
